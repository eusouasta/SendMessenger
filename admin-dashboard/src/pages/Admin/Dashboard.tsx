...
import {
    ...
    PauseCircle, PlayCircle, DollarSign, Activity, Terminal, ExternalLink, RefreshCw, MessageCircle
} from 'lucide-react';
import {
        ...
        <div className="min-h-screen bg-[#050505] flex text-gray-100 font-sans selection:bg-blue-500/30">
            ...
            <aside className="w-64 bg-[#111113] border-r border-white/5 flex flex-col fixed h-full z-20">
                ...
                <nav className="flex-1 p-4 space-y-1">
                    ...
                    <button onClick={() => window.location.href = '/admin-panel/chat'} className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium text-gray-400 hover:bg-white/5 hover:text-white transition-all">
            ...
            <main className="flex-1 ml-64 p-8">
                ...
                {activeView === 'webhooks' && (
                    <div className="max-w-5xl mx-auto">
                        ...
                        {/* Quick Actions (INSERTED CHAT BUTTON) */}
                        <div className="mb-8 flex gap-4">
                            <button
                                onClick={() => window.location.href = '/admin-panel/chat'}
                                className="bg-blue-600 hover:bg-blue-500 text-white px-6 py-3 rounded-xl font-bold flex items-center gap-2 shadow-lg shadow-blue-500/20 transition-all hover:scale-[1.02]"
                            >
